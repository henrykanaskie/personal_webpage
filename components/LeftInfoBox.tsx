  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`${glassClassNames} p-5 md:p-8 max-w-[650px] min-h-[200px] md:min-h-[250px] mx-auto md:mx-0 md:ml-[5%] w-[calc(100%-2rem)] md:w-auto`}
      >
        ...
        {/* SVG positioned in the top right corner — hidden on mobile */}
        <div
